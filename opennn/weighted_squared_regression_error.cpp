...
WeightedSquaredRegressionError::WeightedSquaredRegressionError() : ErrorTerm()
{
    set_default();
}
...
WeightedSquaredRegressionError::WeightedSquaredRegressionError(NeuralNetwork* new_neural_network_pointer)
...
WeightedSquaredRegressionError::WeightedSquaredRegressionError(DataSet* new_data_set_pointer)
...
WeightedSquaredRegressionError::WeightedSquaredRegressionError(NeuralNetwork* new_neural_network_pointer, DataSet* new_data_set_pointer)
...
WeightedSquaredRegressionError::WeightedSquaredRegressionError(const tinyxml2::XMLDocument& weighted_squared_error_document)
...
WeightedSquaredRegressionError::WeightedSquaredRegressionError(const WeightedSquaredRegressionError& other_weighted_squared_error)
...
WeightedSquaredRegressionError::~WeightedSquaredRegressionError()
{
}
...
double WeightedSquaredRegressionError::get_normalization_coefficient() const
{
...
void WeightedSquaredRegressionError::check() const
{
    ...
    {
        buffer << "OpenNN Exception: WeightedSquaredRegressionError class.\n"
               << "void check() const method.\n"
...
void WeightedSquaredRegressionError::set_default()
{
...
void WeightedSquaredRegressionError::set_normalization_coefficient(const double& new_normalization_coefficient)
{
...
void WeightedSquaredRegressionError::set_weights(const double&, const double&)
{
}
...
void WeightedSquaredRegressionError::set_weights()
{
    // Control sentence
...
void WeightedSquaredRegressionError::set_normalization_coefficient()
{
    // Control sentence
...
double WeightedSquaredRegressionError::calculate_error() const
{
    // Control sentence
...
double WeightedSquaredRegressionError::calculate_error(const Vector<double>& parameters) const
{
...
double WeightedSquaredRegressionError::calculate_selection_error() const
{
    // Control sentence(if debug)
...
double WeightedSquaredRegressionError::calculate_error(const double& given_normalization_coefficient) const
{
    // Control sentence
...
double WeightedSquaredRegressionError::calculate_error(const Vector<double>& parameters, const double& given_normalization_coefficient) const
{
    // Control sentence(if debug)
...
double WeightedSquaredRegressionError::calculate_selection_error(const double& given_normalization_coefficient) const
{
    // Control sentence(if debug)
...
Vector<double> WeightedSquaredRegressionError::calculate_output_gradient(const Vector<double>&, const Vector<double>&) const
{
...
Matrix<double> WeightedSquaredRegressionError::calculate_output_Hessian(const Vector<double>& , const Vector<double>& target) const
{
...
Vector<double> WeightedSquaredRegressionError::calculate_output_gradient(const Vector<double>&, const Vector<double>&, const double&) const
{
    Vector<double> output_gradient;
...
Vector<double> WeightedSquaredRegressionError::calculate_gradient_with_normalization(const double& given_normalization_coefficient) const
{
#ifdef __OPENNN_DEBUG__
...
ErrorTerm::FirstOrderPerformance WeightedSquaredRegressionError::calculate_first_order_loss() const
{
    // Control sentence
...
ErrorTerm::SecondOrderPerformance WeightedSquaredRegressionError::calculate_second_order_loss() const
{
    // Control sentence
...
Vector<double> WeightedSquaredRegressionError::calculate_terms() const
{
    // Control sentence
...
Vector<double> WeightedSquaredRegressionError::calculate_terms(const Vector<double>& network_parameters) const
{
    // Control sentence(if debug)
    ...
    WeightedSquaredRegressionError weighted_squared_error_copy(*this);
...
Matrix<double> WeightedSquaredRegressionError::calculate_terms_Jacobian() const
{
    // Control sentence
    ...
    #pragma omp parallel for private(first_order_forward_propagation, output_gradient, layers_delta, particular_solution, homogeneous_solution, point_gradient)
...
WeightedSquaredRegressionError::FirstOrderTerms WeightedSquaredRegressionError::calculate_first_order_terms() const
{
    // Control sentence(if debug)
...
string WeightedSquaredRegressionError::write_error_term_type() const
{
...
tinyxml2::XMLDocument* WeightedSquaredRegressionError::to_XML() const
{
    ostringstream buffer;
    ...
    tinyxml2::XMLElement* weighted_squared_error_element = document->NewElement("WeightedSquaredRegressionError");
...
void WeightedSquaredRegressionError::write_XML(tinyxml2::XMLPrinter& file_stream) const
{
    ostringstream buffer;

    //file_stream.OpenElement("WeightedSquaredRegressionError");
...
void WeightedSquaredRegressionError::from_XML(const tinyxml2::XMLDocument& document)
{
   const tinyxml2::XMLElement* weighted_element = document.FirstChildElement("WeightedSquaredRegressionError");
...
/*
string WeightedSquaredRegressionError::write_information() const
{
    ostringstream buffer;
...
string WeightedSquaredRegressionError::object_to_string() const
{
    ostringstream buffer;
